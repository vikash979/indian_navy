    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicationfile', models.FileField(blank=True, null=True, upload_to='publicattion/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'JPEG', 'pdf', 'PDF'])])),
                ('folder_title', models.CharField(max_length=200)),
            ],
            options={
                'ordering': ['-id'],
